...
def get_response_team(links: dict) -> list:
    ...
    :param links:словарь с названием команды и ссылкой на ее матчи
